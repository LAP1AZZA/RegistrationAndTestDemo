...
public class ConstantDB {
    ...
    public static final String QUESTIONS_AUTHOR = "AUTHOR";
    public static final String QUESTIONS_TEXT = "QUESTIONS_TEXT";
    public static final String QUESTIONS_ANSWER_TEXT = "ANSWER_TEXT";
}
